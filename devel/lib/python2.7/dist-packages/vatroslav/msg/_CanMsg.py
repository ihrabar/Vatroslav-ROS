...
"""autogenerated by genpy from vatroslav/CanMsg.msg. Do not edit."""
import sys
...
class CanMsg(genpy.Message):
  _md5sum = "4a2f3d2bf382175178ead4deb3882e9c"
  _type = "vatroslav/CanMsg"
...
string time
"""
  __slots__ = ['id','data','size','time']
  _slot_types = ['uint8','string','uint8','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CanMsg, self).__init__(*args, **kwds)
